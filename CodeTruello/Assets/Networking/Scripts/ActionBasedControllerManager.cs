...
// this script will switch the base and teleport controller
//so when you want to teleport, it actives the teleport controller and disable/deactivate the base controller
//and when you finished teleporting, the teleport controller will be disabled/deactivated and active the base controller
/// </summary>
